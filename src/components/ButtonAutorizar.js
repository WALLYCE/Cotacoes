...
export default function ButtonAutorizar(props) {
  ...
  return (
    ...
    {/*Dialog Resusar*/}
        ...
        <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                    <TextField
                            placeholder="Informações adicionais da Autorização"
                            multiline
                            name='Informacao da Solicitacao'
                            rows={4}
                            fullWidth={true}
                    ...
                    {solicitacao.cotacoes && solicitacao.cotacoes.map((item, index)=>{
                        ...
                        return(
                          <Grid container spacing={1} mt={2} key={'autorizarmenu'+index}>
                          <Grid item xs={11}>
                          <Grid  container spacing={2}>
                            <Grid item xs={2}>
                            ...
                            <Grid item xs={2}>
                             ...
                             <Grid item xs={1}>
                              Autorizar
                             <FormControlLabel  control={<Switch onChange={handleSelect} id={item.id_cotacao.toString()} checked={(item.autorizado == "true" ? true : false)} />} />
                              </Grid>
                            </Grid>
                        )
                    })}
